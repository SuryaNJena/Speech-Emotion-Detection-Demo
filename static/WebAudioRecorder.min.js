    ...
    var e=function(){
        ...
        for(var n=0;n<t.length;++n){
            ...
            for(key in r){
                ...
                i.connect(this.input);this.buffer=[];
                this.initWorker()};
                e(i.prototype,{isRecording:function(){return this.processor!=null},
                setEncoding:function(e){
                    ...
                    startRecording:function()
                    {
                        ...
                        {
                            var i=this.numChannels,e=this.buffer,n=this.worker;this.processor=this.context.createScriptProcessor(this.options.bufferSize,this.numChannels,this.numChannels);
                            ...
                            this.processor.onaudioprocess=function(t)
                            {
                                ...
                                this.startTime=Date.now()}},recordingTime:function()
                                {
                                ...
                                initWorker:function()
                                {
                                    ...
                                    this.worker.onmessage=function(n)
                                    {
                                        ...
                                        switch(i.command)
                                        {
                                            ...
                                            onError:function(i,e){console.log(e)}});n.WebAudioRecorder=i})(window);
